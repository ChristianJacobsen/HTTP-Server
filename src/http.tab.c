...
{
  "$end", "error", "$undefined", "SP", "CRLF", "method", "requesttarget",
  "HTTPversion", "fieldname", "fieldvalue", "headerfield", "messagebody",
  "$accept", "HTTPmessage", "requestline", "sheaderfield", YY_NULLPTR
};
#endif
...
{
       8,     4,     1,     5,    10,     7,     9,    12,    11,    13
};

static const yytype_uint8 yycheck[] =
{
       4,     3,     5,     0,     3,     6,    10,     7,     4,     4
};
